...
export default function MinimalLightButton() {
    return (
        ...
        <span className="absolute inset-0 pointer-events-none select-none">
          <span
              ...
              style={{
                  background: "linear-gradient(135deg, #1a1a1a, #2e2e2e, #0a0a0a)",
              }}
          />
        </span>
      </span>
        ...
        <span className="relative group-hover:scale-105 transition-transform duration-500">
          ...
          <StarShine
              ...
              style={{
                  background:
                      "linear-gradient(135deg, #111111, #1f2937, #4b5563, #0a0a0a)",
              }}
          />
        </span>

        <span className="ml-1.5 text-xs bg-clip-text text-transparent bg-gradient-to-b from-black to-black/50 group-hover:scale-105 transition transform-gpu">
          Minimal Interface
        </span>
      </span>
        </button>
