...
const BorderGlowTranslate = styled.span`
    animation: ${glowTranslate} 10s ease-in-out infinite alternate;
`;

const BorderGlowScale = styled.span`
    animation: ${glowScale} 10s ease-in-out infinite alternate;
`;
...
export default function UIHeavyButton() {
    return (
