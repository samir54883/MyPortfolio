...
// Keyframes (equivalent to CSS animations)
...
const StarRotate = styled.svg`
  animation: ${starRotate} 14s cubic-bezier(0.68, -0.55, 0.27, 1.55) infinite alternate;
`;
...
export default function UIHeavyLightButton() {
    return (
        <div className="flex items-center justify-center bg-transparent">
          ...
          <span className="inset-0 absolute pointer-events-none select-none">
            ...
            ></span>
                ...
                {/* Border Glow */}
                <BorderGlowTranslate className="inset-0 absolute pointer-events-none select-none">
                    <BorderGlowScale
                ...
                {/* Content */}
                <span className="flex items-center justify-center gap-1 relative z-[1] bg-white/90 rounded-full py-2 px-4 pl-2 w-full">
          <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
            ...
            <StarShine
                className="rounded-full size-11 absolute opacity-40 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-lg"
                style={{
                    background:
          ...
          <span className="bg-gradient-to-b ml-1.5 from-black to-black/50 bg-clip-text text-xs text-transparent group-hover:scale-105 transition transform-gpu">
            Enhanced Interface
          </span>
        </span>
            </button>
